...
def run_pipeline_in_pythiags_launch(context):
    code, stdout, stderr = run_read_console(f"pythiags launch {context.pipeline}")
...
def step_impl(context):
    raise NotImplementedError('STEP: Then I get friendly errors sayng how to correct it')
